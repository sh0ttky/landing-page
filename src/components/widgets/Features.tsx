...
const Features = ({ id, header, items, columns = 3, hasBackground = false }: FeaturesProps) => (
  <WidgetWrapper id={id ? id : ''} hasBackground={hasBackground} containerClass="scroll-mt-16 max-w-6xl">
    ...
    <Image src="/aboutuz.png" width="3000" alt="image" />FeaturesProps
    ...
    <ItemGrid
      ...
      iconClass="h-12 w-12 flex items-center justify-center rounded-md text-white bg-foreground p-2 md:p-3 mt-1.5 mb-4 mr-4 rtl:ml-4 rtl:mr-0"
