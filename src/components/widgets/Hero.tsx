...
const Hero = ({ title, subtitle, tagline, callToAction, callToAction2, image }: HeroProps) => {
  return (
    <section id="heroOne">
      <div className="bg-gray-50 mx-auto max-w-full px-4 sm:px-6">
          ...
          <div className="mx-auto max-w-4xl pb-10 text-center md:pb-16">
            ...
            <div className="mx-auto max-w-3xl">
              ...
              <div className="flex max-w-none flex-col flex-nowrap gap-4 px-4 sm:flex-row sm:justify-center">
                {callToAction && <CTA callToAction={callToAction} linkClass="btn bg-foreground" />}
              </div>
            </div>
          </div>
          {image && (
            <div className="m-auto max-w-5xl">
              <Image
                ...
                width={2024}
                height={607}
                sizes="(max-width: 84rem) 100vw, 2024px"
                loading="eager"
                placeholder="blur"
                priority
              />
